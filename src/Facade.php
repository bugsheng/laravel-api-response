 ...
 *
 * @method static \BugSheng\Laravel\ApiResponse\ApiJsonResponse make($message = '', $data = [], $serverCode = 0, $httpCode = 200, array $headers = [])
 * @method static \Illuminate\Http\JsonResponse success($data = [], string $message = '')
 * @method static \Illuminate\Http\JsonResponse fail($data = [], string $message = '', int $errCode = 100000)
 ...
 * @method static \Illuminate\Http\JsonResponse validatorError($data = [], $message = '表单验证不通过')
